"""Regression checks for the ember-svc-notify-forge casebook."""
...
from casebook.harness import assert_expected, ember_svc_notify_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ember_svc_notify_forge_summary(), assert_expected())
